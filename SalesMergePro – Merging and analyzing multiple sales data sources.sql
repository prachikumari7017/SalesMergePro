...
-- 1. Find total number of sales transactions?

SELECT COUNT(8) AS total_sales FROM sales_overall;

-- 2. Calculate the total revenue generated by each product and show only those that earned more than $1,200?
...
-- 3. Find the average order value (AOV) per customer?
...
-- 4. Show the top 3 highest revenue-generating customers?
...
-- 6. Get the top 5 best-selling products by revenue?
...
-- 7. Get the running total revenue by date (window function)?
